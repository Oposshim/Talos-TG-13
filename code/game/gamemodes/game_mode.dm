...
/datum/game_mode/proc/generate_credit_text()
	...
	// HEADS OF STAFF
	round_credits += "<center><h1>The Command Staff:</h1>"
	...
	// SILICONS
	round_credits += "<center><h1>Silicon Intelligences:</h1>"
	len_before_addition = round_credits.len
	...
	// SECURITY
	round_credits += "<center><h1>The Security Officers:</h1>"
	len_before_addition = round_credits.len
	...
	// MEDICAL
	round_credits += "<center><h1>The Medical Department:</h1>"
	len_before_addition = round_credits.len
	...
	// ENGINEERING
	round_credits += "<center><h1>The Engineers:</h1>"
	len_before_addition = round_credits.len
	...
	// SCIENCE
	round_credits += "<center><h1>The Science Department:</h1>"
	len_before_addition = round_credits.len
	...
	// CARGO
	round_credits += "<center><h1>The Cargo Department:</h1>"
	len_before_addition = round_credits.len
	...
	round_credits += "<center><h1>The Civilians:</h1>"
	len_before_addition = round_credits.len
	...
	round_credits += "<center><h1>The Volunteers:</h1>"
	len_before_addition = round_credits.len
